...
<section class="news-carousel-card" aria-labelledby="banner-title">
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-slide active">
            <h1 id="banner-title" class="banner-heading">Súmate al próximo torneo</h1>
            <p class="banner-description">Participa en torneos de multiples disciplinas de forma dinamica!</p>
            <div class="banner-actions">
                <a href="calendario.php" class="btn btn-secondary">Calendario</a>
                <a href="busquedaTorneo.php" class="btn btn-primary">Explorar</a>
            </div>
        </div>
