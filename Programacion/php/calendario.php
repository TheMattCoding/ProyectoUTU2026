...
if (!empty($fotoPerfilRaw)) {
    // Si la ruta ya tiene '../' o es URL completa, se usa tal cual; si no, se antepone '../'
...
<head>
    ...
    <title>SGDM - Calendario de Torneos</title>
...
<nav class="navbar" aria-label="Navegación principal">
    ...
    <div class="notifications-menu-card">
        ...
        <!-- Apartado de Perfil con foto dinámica -->
