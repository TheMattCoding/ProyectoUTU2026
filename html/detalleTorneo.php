...
<head>
    ...
    <title>Detalle del Torneo - UTU</title>
...
<div class="contenedor-celular">
    ...
    <main class="contenido-principal">
        ...
        <div class="portada-torneo">
            <img src="https://images.unsplash.com/photo-1529699211952-734e80c4d42b?w=500" alt="Imagen del Torneo">
            <div class="superposicion-portada">
                <span class="categoria-torneo">Ajedrez / Tablero</span>
                <h1 class="nombre-torneo">Torneo de Ajedrez</h1>
            </div>
        </div>
        ...
        <section class="seccion-info-rapida">
            <div class="elemento-info">
                ...
                <span>ITS Arias Balparda, Montevideo</span>
            </div>
            <div class="elemento-info">
                <i class="fas fa-calendar-alt"></i>
                <span>Sábado, 26 de Julio a las 08:00 AM</span>
            </div>
        </section>
        ...
        <section class="bloque-descripcion">
            ...
            <p class="texto-descripcion">
                Un torneo suizo pensado para jugadores de todos los niveles. Vení a poner a prueba tu estrategia, competir con compañeros de otros módulos y ganar importantes premios. ¡Trae tu propio tablero si tenés disponible!
            </p>
        </section>
        ...
        <section class="rejilla-info-tecnica">
            <div class="tarjeta-tecnica">
                ...
                <div class="valor-tarjeta-tecnica">Sistema Suizo (5 Rondas)</div>
            </div>
            <div class="tarjeta-tecnica">
                <div class="etiqueta-tarjeta-tecnica">Creador</div>
                <div class="valor-tarjeta-tecnica">Usuario</div>
            </div>
        </section>
        ...
        <section class="contenedor-cupos">
            <div class="encabezado-cupos">
                ...
                <span>8 / 16 participantes</span>
            </div>
            <div class="barra-progreso">
                <div class="relleno-progreso"></div>
            </div>
        </section>

        <button class="btn-inscribirse">Inscribirse Ahora</button>
